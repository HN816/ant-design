...
var _usePopupScope = require("./usePopupScope");
Object.keys(_usePopupScope).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _usePopupScope[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _usePopupScope[key];
    }
  });
});
